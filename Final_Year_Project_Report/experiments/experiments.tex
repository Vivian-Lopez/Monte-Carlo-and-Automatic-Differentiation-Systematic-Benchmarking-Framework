...
Successive halving &
SHA evaluates all candidates at small probe budgets, promotes a smaller active
set through \(M=1k\), \(5k\) and \(25k\), then selects 24 of the 48 full-grid cells
for full benchmarking. Post-hoc instance slices are used as a robustness check. &
Same decision-quality metrics as the old profiler, plus promotion behaviour and
probe path-budget saving. \\
\bottomrule
\end{tabularx}
\end{table}
...
and finally \code{sha_cloud_profiler_v4}. This order keeps GBM as the correctness
