...
\caption{Guarded SHA local-volatility recommendations and pure runtime/cost baselines. The weighted recommendation is compared with the pure fastest and pure cheapest configuration in the same candidate pool.}
...
\setlength{\tabcolsep}{3pt}
\renewcommand{\arraystretch}{1.08}
\caption{Same-grid profiler comparison for the balanced guarded-SHA objective. Guarded SHA uses more full runs than plain SHA, but adds explicit safeguards.}
