...
The strongest quantitative conclusions are therefore scoped to the implemented
CPU engines, the JAX AD path, and the Google Cloud CPU experiments evaluated in
this report. GPU support and broader AD-system coverage are present as
prototype infrastructure or future extensions, but they are not used as the
basis for the final comparative claims.
